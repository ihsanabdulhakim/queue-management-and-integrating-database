...
db_path = 'resultqueuemanagement.db'
...
video_writer = cv2.VideoWriter("video-result-queue.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
                ...
                for i, box in enumerate(boxes):
                    ...
                    if result.names[cls_id] == 'person' and obj_id not in seen_ids:
                        ...
                        if is_point_in_polygon(center_x, center_y, queue_region):
                            ...
                            cursor.execute('''
                            INSERT INTO table-queue-management (obj_id, timestamps, x1, y1, x2, y2) VALUES (?, ?, ?, ?, ?, ?)
